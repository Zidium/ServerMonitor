...
namespace ZidiumServerMonitor
{
    internal static class Application
    {
        public static void ConfigureServices(HostBuilderContext hostContext, IServiceCollection services)
        {
            ...
            services.AddSingleton<IZidiumComponentsProvider, ZidiumComponentsProvider>();
            ...
            services.AddTransient<DiskPerformanceDataboxService>();
            services.AddSingleton<DiskPerformanceDataboxServiceFactory>();
        }
        ...
        public static void OnStart(Microsoft.Extensions.Logging.ILogger logger, IServiceProvider services)
        {
            ...
            logger.LogInformation($"Environment: {services.GetRequiredService<IHostEnvironment>().EnvironmentName}");
